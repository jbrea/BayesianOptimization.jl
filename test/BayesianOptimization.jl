@testset "Merge with defaults" begin
    ...
    args, kwargs = BO.merge_with_defaults(f, l, u,
                                          (sense = Max,
    ...
    @test_throws ArgumentError BO.merge_with_defaults(f, l, u,
                                                      (lowerbounds = [],
                                                       upperbounds = [-1, -100]))
    ...
    @test_throws ArgumentError BO.merge_with_defaults(f, [1.0], [3.0, 4.0], (;))
end
